...
class AmentiesListComponent extends Component {
    render() {
        return (
            <>
                <Row className="largest_only" style={{ marginRight: "unset", marginLeft: "unset" }}>

                    <Col style={{ padding: "unset", paddingBottom: "20px" }}>
                        {amenties.map((amenity, i) => (
                            <div style={{ display: "flex", gap: "10px", margin: "15px auto 15px 100px" }} key={i}>
                ...
                <Row className="gone_on_largest"style={{ marginRight: "unset", marginLeft: "unset" }}>
